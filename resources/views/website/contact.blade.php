        ...
        <div class="row same-height justify-content-center">
            <div class="col-md-12 col-lg-10">
                <div class="post-entry text-center">
                    <span class="post-category text-white bg-success mb-3">No</span>
                    <h1 class="mb-4"><a href="javascript:void()">Yes</a></h1>
                    <div class="post-meta align-items-center text-center">
                        <figure class="author-figure mb-0 mr-3 d-inline-block">
                            <img src="" alt="Image" class="img-fluid">
                        </figure>
                        <span class="d-inline-block mt-1">By Me</span>
                        <span>Lal</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12 col-lg-4 sidebar">
                ...
                <div class="sidebar-box">
                    ...
                    <ul class="categories">
                        ...
                        <li><a href="#">Name <span>(12)</span> </a></li>
        ...
        <div class="row align-items-stretch retro-layout">
            ...
            <div class="col-md-7">
                ...
                <div class="two-col d-block d-md-flex justify-content-between">
                    ...
                    <a href="post slug" class="hentry v-height img-2 gradient"
                        style="background-image: url('');">
