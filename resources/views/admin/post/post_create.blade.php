                                        ...
                                        <form action="{{route('post.store')}}" method="POST" enctype="multipart/form-data" role="form">
                                          ...
                                          @include('includes.error')
                                            ...
                                            <div class="form-group">
                                              ...
                                              <img src="{{asset('storage/image/')}}" id="image" style="width:565px;height:300px">
                                              <input id="my-input" class="form-control" type="file" name="image" id="image" onchange="showImage(this,'image')" value=''>
                                            </div>
                                            <div class="form-group">
